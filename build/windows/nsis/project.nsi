...
####
## !define INFO_PROJECTNAME    "my-project" # Default "Yoru"
## !define INFO_COMPANYNAME    "d0kur0" # Default "d0kur0"
## !define INFO_PRODUCTNAME    "Yoru Name" # Default "Yoru"
## !define INFO_PRODUCTVERSION "1.0.0"     # Default "0.1.0"
## !define INFO_COPYRIGHT      "(c) Now, d0kur0" # Default "© 2026, d0kur0"
###
...
Section "uninstall"
    ...
    nsExec::ExecToLog 'schtasks /delete /tn "Yoru" /f' # harmless no-op if it was never created (user-scope installs)
